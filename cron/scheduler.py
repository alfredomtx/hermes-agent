            ...
            try:
                ...
                if text_to_send:
                    ...
                    if future is None:
                        ...
                        # fresh thread — all before treating it as a failure.
                        if (
                            topic_meta
                            and thread_id
                        ...
                        if send_result is None or not getattr(send_result, "success", True):
                            ...
                            # No topic_meta: legacy behavior (message landed in
                            # group root). Record the misroute as before.
